Ext.define 'Toro.view.match.event.SubstitutionListView',
    ...
    getGridsEventRecords: (context) ->
        ...
        if subStitutionRecord.phantom
            ...
            substitutionOffRecord = Ext.create 'Toro.model.MatchEvent',
            ...
            substitutionOnRecord = Ext.create 'Toro.model.MatchEvent',
                side: subStitutionRecord.get 'side'
                minute: subStitutionRecord.get 'minute'
                second: subStitutionRecord.get 'second'
                period: 'FirstHaft'
    ...
    initComponent: ->
        ...
        @store = Ext.create 'Ext.data.Store',
            model: 'Toro.model.Substitution'

        # event store
        @eventsStore = Ext.create 'Toro.store.MatchEvents',
            pageSize: 50
                ...
                if records.length
                    Ext.each records, (record) =>
                        ...
                        if type.get('id') == 36
                            ...
                            substitutionRecord = Ext.create 'Toro.model.Substitution',
