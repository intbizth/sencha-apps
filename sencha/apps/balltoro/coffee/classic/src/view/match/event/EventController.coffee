Ext.define 'Balltoro.view.match.event.EventController',
    ...
    setPlayersStore: (matchRecord) ->
        ...
        if Ext.isArray(homePlayers) and homePlayers.length
            Ext.each homePlayers, (player) ->
                playerRecond = Ext.create 'Balltoro.model.Personal',
                    player
    ...
    createNewGridRow: (ref, eventType) ->
        ...
        newRecord = Ext.create 'Balltoro.model.MatchEvent',
            side: 'home'
            minute: 0
            second: 0
            period: 'FirstHaft'
    ...
    onAddSubstitution: ->
        ...
        newRecord = Ext.create 'Balltoro.model.Substitution',
            playerOff: null
            playerOn: null
            side: 'home'
            minute: 0
